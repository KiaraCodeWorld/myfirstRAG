...
#print(pdf_to_text("./data/pet.pdf"))
...
#print(customer_embedder([chunks[0]]))


#var1 = [[-0.011131569, 0.018651238 ], [-0.011131569, 0.018651238 ]]
#var2 = [[[-0.011131569, 0.018651238 ]], [[-0.011131569, 0.018651238 ]]]
...
embeddings_list_v2 = [item for sublist in embeddings_list for item in sublist]

#client = chromadb.PersistentClient(path="./db")
chroma_client = chromadb.PersistentClient(path="../mydb_flblue")
chroma_client.delete_collection("rag_collection_flblue")
collection = chroma_client.create_collection(name="rag_collection_flblue")

collection.add(
            embeddings=embeddings_list_v2,
