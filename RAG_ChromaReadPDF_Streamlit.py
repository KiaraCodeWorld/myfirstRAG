...
class RAGPipeline():
    def __init__(self) -> None:
        self.API_TOKEN = "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" # "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" # #os.environ["API_TOKEN"]
        self.API_URL = "https://api-inference.huggingface.co/models/HuggingFaceH4/zephyr-7b-alpha"
#"https://z8dvl7fzhxxcybd8.eu-west-1.aws.endpoints.huggingface.cloud/" #"https://api-inference.huggingface.co/models/HuggingFaceH4/zephyr-7b-alpha"
...
#st.sidebar.text_input("Context Area", key="contextArea", value=st.session_state['contextArea'])
#st.sidebar.write(f"Current Context Area: {st.session_state['contextArea']}")
